...
const toCelsius = function (temperatures) {
  // Your code here
  const tempinC = temperatures.map((temperature) => {
...
const hottestDays = function (temperatures, threshhold) {
  // Your code here
  const filterTemps = temperatures.filter((temperature) => {
    return temperature > threshhold;
  });
  return filterTemps;

  //   const filterTemps = temperatures.forEach((temperature) => {
...
const logHottestDays = function (temperatures, threshhold) {
  // Your code here
  const hotestTemps = hottestDays(temperatures, threshhold);
  const hottestDaysinC = toCelsius(hotestTemps);
  logger(hottestDaysinC);
};
